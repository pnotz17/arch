...
static Key keys[] = {
	...
	{ Mod1Mask|ControlMask,         XK_h,	   incnmaster,     {.i = +1 } },
	{ Mod1Mask|ControlMask,         XK_v,      incnmaster,     {.i = -1 } },
	...
	{ ControlMask,		        XK_w,      spawn,          SHCMD("~/.local/bin/ch_wall") },
	{ Mod1Mask,			XK_a,	   spawn,	   SHCMD("~/.local/bin/dm_alias") },
	...
	{ Mod1Mask,		        XK_k,	   spawn,	   SHCMD("~/.local/bin/dm_kl") },
	{ Mod1Mask,		        XK_m,	   spawn,	   SHCMD("~/.local/bin/dm_man") },
	{ Mod1Mask,		        XK_s,	   spawn,	   SHCMD("~/.local/bin/dm_yt") },
