...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,	        XK_h,	   spawn,	   SHCMD("~/.local/bin/dm_hs") },
	{ MODKEY|ControlMask,	        XK_c,	   spawn,	   SHCMD("~/.local/bin/dm_col") },
	{ MODKEY|ControlMask,	        XK_t,	   spawn,	   SHCMD("~/.local/bin/dm_mp") },
	...
	{ ControlMask,		        XK_e,	   spawn,	   SHCMD("~/.local/bin/dm_mo") },
	{ ControlMask,		        XK_g,	   spawn,	   SHCMD("~/.local/bin/dm_gl") },
	{ ControlMask,		        XK_p,	   spawn,	   SHCMD("~/.local/bin/dm_pm") },
	{ ControlMask,		        XK_w,	   spawn,	   SHCMD("~/.local/bin/dm_feh") },
	{ ControlMask,		        XK_k,	   spawn,	   SHCMD("~/.local/bin/dm_kl") },
	...
	{ MODKEY,		        XK_e,      spawn, 	   SHCMD("~/.local/bin/dm_exe") },
	{ MODKEY,			XK_c,      spawn,          SHCMD("~/.local/bin/dm_calc") },
	{ MODKEY,                       XK_s,	   spawn,          SHCMD("~/.local/bin/dm_sm") },
