...
static Key keys[] = {
	...
	{ Mod1Mask|ControlMask,			XK_j,	   movestack,      {.i = +1 } },
	{ Mod1Mask|ControlMask,			XK_k,	   movestack,	   {.i = -1 } },
	...
	{ Mod1Mask,                  XK_h,	   incnmaster,     {.i = +1 } },
	{ Mod1Mask,                  XK_v,      incnmaster,     {.i = -1 } },
	...
	{ Mod1Mask,           XK_x,	   spawn,          SHCMD("~/.local/bin/dm_x") },
	{ Mod1Mask,		XK_d,	   spawn,	   SHCMD("~/.local/bin/dm_duck") },
	{ Mod1Mask,	                XK_w,      spawn,          SHCMD("~/.local/bin/ch_wall") },
	{ Mod1Mask,		        XK_e,      spawn, 	   SHCMD("~/.local/bin/dm_power") },
	{ Mod1Mask,	                XK_m,	   spawn,	   SHCMD("~/.local/bin/dm_man") },
	{ Mod1Mask,			XK_c,      spawn,          SHCMD("~/.local/bin/dm_calc") },
