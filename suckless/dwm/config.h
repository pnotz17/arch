static const char *fonts[] = {"Monospace:size=12:antialias=true:autohint=true","Noto Color Emoji:style=Regular:size=8:antialias=true:autohint=true",};
static const char dmenufont[]	 = {"Monospacestyle=Book:size=12:antialias=true:autohint=true"};
