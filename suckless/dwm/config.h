...
static Key keys[] = {
	...
	{ ShiftMask,                    XK_t,      setlayout,      {.v = &layouts[0]} },
	{ ShiftMask,                    XK_f,      setlayout,      {.v = &layouts[1]} },
	{ ShiftMask,                    XK_m,      setlayout,      {.v = &layouts[2]} },
	{ ShiftMask,                    XK_g,      setlayout,      {.v = &layouts[3]} },
	...
	{ ControlMask,		        XK_p,	   spawn,	   SHCMD("~/.local/bin/dm_pdf") },
	{ ControlMask,		        XK_w,	   spawn,	   SHCMD("~/.local/bin/dm_wall") },
	...
	{ MODKEY,		        XK_e,      spawn, 	   SHCMD("~/.local/bin/dm_power") },
	{ MODKEY,	                XK_m,	   spawn,	   SHCMD("~/.local/bin/dm_man") },
	{ MODKEY,			XK_c,      spawn,          SHCMD("~/.local/bin/dm_calc") },
	{ MODKEY,                       XK_s,	   spawn,          SHCMD("~/.local/bin/dm_bin") },
