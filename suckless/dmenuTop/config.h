...
static unsigned int lines      	=10;			/* -l and -g options; controls number of lines and columns in grid if > 0 */
static unsigned int lineheight 	= 1;         		/* -h option; minimum height of a menu line     */
static unsigned int columns    	= 5;                    /* number of columns displayed*/
