...
static const char *fonts[] 	   = {"ShureTechMono Nerd Font:style=Regular:size=10:antialias=true:autohint=true","EmojiOne:style=Regular:size=10:antialias=true:autohint=true"};
