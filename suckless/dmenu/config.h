...
static const char *fonts[] 	   = {"FiraCode Nerd Font:style=Light,Regular:size=10:antialias=true:autohint=true","EmojiOne:style=Regular:size=10:antialias=true:autohint=true"};
