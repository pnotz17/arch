...
static const char *fonts[] 	   = {"DaddyTimeMono Nerd Font:style=Book:size=11:antialias=true:autohint=true","EmojiOne:style=Regular:size=9:antialias=true:autohint=true"};
