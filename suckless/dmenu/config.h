...
static const char *fonts[] 	   = {"ShureTechMono Nerd Font:style=Regular:size=11:antialias=true:autohint=true","EmojiOne:style=Regular:size=11:antialias=true:autohint=true"};
...
static unsigned int lines      	   = 81;	/* -l and -g options; controls number of lines and columns in grid if > 0 */
