...
---VARIABLES
myFont          = "xft:UbuntuMono Nerd Font:regular:pixelsize=14"
...
main = do
    ...
    xmproc <- spawnPipe "xmobar -x 0 /home/panos21/.config/xmobar/.xmobarrc"
    ...
    xmonad $ ewmh desktopConfig
        ...
        , logHook = dynamicLogWithPP xmobarPP
                        ...
                        , ppCurrent = xmobarColor "#d8dee9" "" . wrap "[" "]" -- Current workspace in xmobar
                        ...
                        , ppUrgent = xmobarColor "#b3afc2" "" . wrap "!" "!"  -- Urgent workspace
        ...
        , normalBorderColor  = "#575757"
        , focusedBorderColor = "#575757"
        } `additionalKeysP`         myKeys 

---AUTOSTART
myStartupHook = do
          spawnOnce "/home/panos21/bin/run.xmonad &"
          setWMName "xmonad"
...
myKeys =
    ...
    -- Windows
        , ("M-c", killAll)                           -- Kill the currently focused client
        , ("M-S-c",  kill1)                          --                         -- Kill all the windows on current workspace
    ...
    -- Screenshot Key
        , ("M-S-<Print>", spawn "scrot -e 'mv $f ~/Pictures/Screenshots/%Y-%m-%d-%H-%M-%S.png 2>/dev/null'")
        , ("M-S-i", spawn "amixer set Master Front 3+")
        , ("M-S-d", spawn "amixer set Master Front 3-")
...
tall       = renamed [Replace "tall"]     $ limitWindows 12 $ mySpacing 2 $ ResizableTall 1 (3/100) (1/2) []
